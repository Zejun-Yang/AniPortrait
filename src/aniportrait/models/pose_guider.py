...
from aniportrait.models.attention import BasicTransformerBlock


class PoseGuiderModel(ModelMixin, ConfigMixin):
    def __init__(self, noise_latent_channels=320, use_ca=True):
        super(PoseGuiderModel, self).__init__()
        self.register_to_config(
            noise_latent_channels=noise_latent_channels,
            use_ca=use_ca,
        )
